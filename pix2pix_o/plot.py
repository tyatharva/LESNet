...
# Load data
l1 = 'results/0.001_wl1_50_18.0_14_o/exp_latest/20230319_08o.nc'
l2 = 'results/0.001_wl1_50_18.0_14_o/exp_latest/20160118_17o.nc'
l3 = 'results/0.001_wl1_50_18.0_14_o/exp_latest/20221117_15o.nc'

col1 = xr.open_dataset('results/0.001_l1_50_18.0_14_o/exp_latest/20230319_08o.nc')
col2 = xr.open_dataset('results/0.001_l1_50_18.0_14_o/exp_latest/20160118_17o.nc')
col3 = xr.open_dataset('results/0.001_l1_50_18.0_14_o/exp_latest/20221117_15o.nc')
...
# Load elevation
elev_ds = xr.open_dataset('../dem/dem_o.nc')
...
# Save and display
# plt.savefig('o.pdf', dpi=600, bbox_inches='tight')
plt.show()
