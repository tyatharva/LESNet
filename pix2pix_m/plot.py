...
def plot_precipitation(ax, ds, precip_var, title, elevation_data, letter, intensity, cmap='turbo'):
    ...
    ax.text(0.65, 0.95, fss, transform=ax.transAxes, fontsize=16, fontweight='bold', color='black', va='top', ha='left')
...
# Load data
l1 = 'results/0.001_wl1_25_18.0_14_m/exp_latest/20190130_05m.nc'
l2 = 'results/0.001_wl1_25_18.0_14_m/exp_latest/20170129_20m.nc'
l3 = 'results/0.001_wl1_25_18.0_14_m/exp_latest/20211102_14m.nc'

col1 = xr.open_dataset('results/0.001_l1_25_18.0_14_m/exp_latest/20190130_05m.nc')
col2 = xr.open_dataset('results/0.001_l1_25_18.0_14_m/exp_latest/20170129_20m.nc')
col3 = xr.open_dataset('results/0.001_l1_25_18.0_14_m/exp_latest/20211102_14m.nc')
...
# Load elevation
elev_ds = xr.open_dataset('../dem/dem_m.nc')
elev_subset = elev_ds['elev'].values


# Set up figure and axes: 3 rows (dates), 4 cols (models)
fig, axes = plt.subplots(nrows=3, ncols=4, figsize=(20, 20), subplot_kw={'projection': ccrs.PlateCarree()})
plt.subplots_adjust(wspace=0.05, hspace=0.05)
plt.rc('pdf', fonttype=42)

# Column headers: model types
cols = ['HRRR', 'LESNet-A', 'LESNet-B', 'Target']
# Row headers: timestamps
rows = [
...
# Annotate top columns with model names
for ax, col in zip(axes[0], cols):
    ax.annotate(col, xy=(0.5, 1.05), xycoords='axes fraction', 
                ha='center', va='bottom', fontsize=16)

# Annotate left rows with dates
...
plot_precipitation(axes[0, 1], main1, 'Model', '', elev_subset, 'd', 'light')
plot_precipitation(axes[0, 2], col1, 'Model', '', elev_subset, 'g', 'light')
plot_precipitation(axes[0, 3], main1, 'Target', '', elev_subset, 'j', 'light')

# Row 1: l2
plot_precipitation(axes[1, 0], main2, 'HRRR', '', elev_subset, 'b', 'moderate')
plot_precipitation(axes[1, 1], main2, 'Model', '', elev_subset, 'e', 'moderate')
plot_precipitation(axes[1, 2], col2, 'Model', '', elev_subset, 'h', 'moderate')
plot_precipitation(axes[1, 3], main2, 'Target', '', elev_subset, 'k', 'moderate')

# Row 2: l3
plot_precipitation(axes[2, 0], main3, 'HRRR', '', elev_subset, 'c', 'heavy')
plot_precipitation(axes[2, 1], main3, 'Model', '', elev_subset, 'f', 'heavy')
plot_precipitation(axes[2, 2], col3, 'Model', '', elev_subset, 'i', 'heavy')
c1 = plot_precipitation(axes[2, 3], main3, 'Target', '', elev_subset, 'l', 'heavy')
